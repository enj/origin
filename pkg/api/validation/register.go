...
func registerAll() {
	...
	Validator.MustRegister(&authorizationapi.AccessRestriction{}, authorizationvalidation.ValidateAccessRestriction, authorizationvalidation.ValidateAccessRestrictionUpdate)
