...
func TestEscalationProtection(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expectedRules: []rbacv1.PolicyRule{DiscoveryRule, {APIGroups: []string{""}, Resources: []string{"pods"}}},
			scopes:        []string{ClusterRoleIndicator + "admin:*"},
		},
		{
			...
			expectedRules: []rbacv1.PolicyRule{DiscoveryRule, {APIGroups: []string{}, Resources: []string{"pods", "secrets"}}},
			scopes:        []string{ClusterRoleIndicator + "admin:*"},
		},
		{
			...
			expectedRules: []rbacv1.PolicyRule{DiscoveryRule, {APIGroups: []string{"foo"}, Resources: []string{"pods", "secrets"}}},
			scopes:        []string{ClusterRoleIndicator + "admin:*"},
		},
		{
			name: "access tokens",
			...
			expectedRules: []rbacv1.PolicyRule{DiscoveryRule, {APIGroups: []string{"", "and-foo"}, Resources: []string{"pods"}}},
			scopes:        []string{ClusterRoleIndicator + "admin:*"},
		},
		{
