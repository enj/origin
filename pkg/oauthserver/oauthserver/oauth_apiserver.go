...
func buildSessionAuth(secure bool, config *osinv1.SessionConfig, bootstrapUserDataGetter bootstrap.BootstrapUserDataGetter) (session.SessionAuthenticator, error) {
