	...
	roles := []rbac.ClusterRole{
		...
		},
		{
			...
			Rules: []rbac.PolicyRule{
				...
				rbac.NewRule(readWrite...).Groups(extensionsGroup).Resources("jobs", "horizontalpodautoscalers", "replicationcontrollers/scale",
		...
		},
		{
			...
			Rules: []rbac.PolicyRule{
				...
				rbac.NewRule(read...).Groups(extensionsGroup).Resources("jobs", "horizontalpodautoscalers", "replicasets", "replicasets/scale",
		...
		},
		{
			...
			Rules: []rbac.PolicyRule{
				...
				rbac.NewRule("get", "list").Groups(rbacGroup).Resources("clusterroles").RuleOrDie(),
