...
</summary><details><summary>  <span title="(array) The whitelist of subjects that are allowed to perform the actions defined by MatchAttributes. Note that this only prevents a denial due to the access restriction. The subject must still have a matching RBAC binding to actually perform the current action.">allowedSubjects</span>:
...
</div></details></details></details><details><summary>  <span title="(array) The blacklist of subjects that are not allowed to perform the actions defined by MatchAttributes. This restriction is processed before all RBAC data, and thus will reject actions that RBAC may otherwise permit.">deniedSubjects</span>:
</summary><details><summary>  - <span title="(v1.GroupRestriction) GroupRestriction matches against group subjects. Use system:serviceaccount:NAMESPACE to target all service accounts in a specific namespace. Use system:serviceaccounts to target all service accounts.">groupRestriction</span>:
</summary><details><summary>  -   <span title="(array) Groups is a list of groups used to match against an individual user&#39;s groups. If the user is a member of one of the whitelisted groups, the user is allowed to be bound to a role.">groups</span>:
</summary><div style="margin-left:13px;">  -   - <span title="(string)">[string]</span>:
</div></details><details><summary>      <span title="(array) Selectors specifies a list of label selectors over group labels.">labels</span>:
...
</div></details></details></details><details><summary>  <span title="(array) If these rules cover the current request, then this restriction applies. If AllowedSubjects is set, then only those subjects can perform the matching actions. If DeniedSubjects is set, then only those subjects are restricted from performing the matching actions. Required.">matchAttributes</span>:
