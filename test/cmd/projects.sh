...
os::cmd::expect_failure_and_text 'oc annotate namespace nstestproj key4=val4 --overwrite' 'Error from server: User "nstest" cannot "patch" "namespaces" with name "nstestproj" in project "nstestproj"'
...
os::cmd::expect_failure_and_text 'oc label namespace nstestproj keyD=valD --overwrite' 'Error from server: User "nstest" cannot "patch" "namespaces" with name "nstestproj" in project "nstestproj"'
os::test::junit::declare_suite_end
